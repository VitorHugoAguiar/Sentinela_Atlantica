...
public final class H264Extractor implements Extractor {
    ...
    private static long sampleTime = 33332; //10000; //33332->120fps// todo: try to lower this. it directly infer on speed and latency. this should be equal to 16666 to reach 60fps but works better with lower value
