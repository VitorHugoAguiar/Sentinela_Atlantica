...
public final class H264Extractor implements Extractor {
    ...
    private static long sampleTime = 10000; //10000; // todo: try to lower this. it directly infer on speed and latency. this should be equal to 16666 to reach 60fps but works better with lower value
